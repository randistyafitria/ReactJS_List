    ...
    render() {
        ...
        <div className="container">  
	          ...
	          {this.state.siswa.map((item,index) => {  
	            return (  
	              <li className="list-group-item" key={index}>  
	                ...
	                <button className="btn btn-sm btn-primary m-1" onClick={() => this.Edit(item)} data-toggle="modal" data-target="#modal">Edit</button>  
	        ...
	        <div className="modal fade" id="modal">  
		  	...
		  	/* fungsi ini digunakan untuk memasukkan data dari elemen input ke variable state. 
